...
KeyTable REMOTE_KEYS[] = {
  // Number keys
  {{0x07,0x000a,0x0000,0x00}, MOD_NONE, KEY_0},
  {{0x07,0x000a,0x0001,0x00}, MOD_NONE, KEY_1},
  {{0x07,0x000a,0x0002,0x00}, MOD_NONE, KEY_2},
  {{0x07,0x000a,0x0003,0x00}, MOD_NONE, KEY_3},
  {{0x07,0x000a,0x0004,0x00}, MOD_NONE, KEY_4},
  {{0x07,0x000a,0x0005,0x00}, MOD_NONE, KEY_5},
  {{0x07,0x000a,0x0006,0x00}, MOD_NONE, KEY_6},
  {{0x07,0x000a,0x0007,0x00}, MOD_NONE, KEY_7},
  {{0x07,0x000a,0x0008,0x00}, MOD_NONE, KEY_8},
  {{0x07,0x000a,0x0009,0x00}, MOD_NONE, KEY_9},
  // Arrow keys
  {{0x07,0x000a,0x0055,0x00}, MOD_NONE, KEY_LEFT},
  {{0x07,0x000a,0x0056,0x00}, MOD_NONE, KEY_RIGHT},
  {{0x07,0x000a,0x0050,0x00}, MOD_NONE, KEY_UP},
  {{0x07,0x000a,0x0051,0x00}, MOD_NONE, KEY_DOWN},
  // OK-Button
  {{0x07,0x000a,0x0057,0x00}, MOD_NONE, KEY_ENTER},
  // Back or Exit
  {{0x07,0x000a,0x0053,0x00}, MOD_NONE, KEY_BACKSPACE},
  // Info-Key
  {{0x07,0x000a,0x000f,0x00}, MOD_NONE, KEY_I},
  // Menu
  {{0x07,0x000a,0x0048,0x00}, MOD_NONE, KEY_M},
  // Context menu
  {{0x07,0x000a,0x004f,0x00}, MOD_NONE, KEY_C},
  // EPG guide
//  {{}, MOD_NONE, KEY_E},
  // Play
  {{0x07,0x000a,0x0035,0x00}, MOD_NONE, KEY_P},
  // Pause
  {{0x07,0x000a,0x0030,0x00}, MOD_NONE, KEY_SPACE},
  // Stop
  {{0x07,0x000a,0x0036,0x00}, MOD_NONE, KEY_X},
  // Fast forward
  {{0x07,0x000a,0x0034,0x00}, MOD_NONE, KEY_F},
  // Rewind
  {{0x07,0x000a,0x0032,0x00}, MOD_NONE, KEY_R},
  // Volume up
  {{0x07,0x000a,0x0020,0x00}, MOD_NONE, KEYPAD_ADD},
  // Volume down
  {{0x07,0x000a,0x0021,0x00}, MOD_NONE, KEYPAD_SUBTRACT},
  // Mute
  {{0x07,0x000a,0x0046,0x00}, MOD_NONE, KEY_F8},

  // Red
  {{0x07,0x000a,0x006b,0x00}, MOD_NONE, KEY_F1},
  // Green
  {{0x07,0x000a,0x006c,0x00}, MOD_NONE, KEY_F2},
  // Yellow
  {{0x07,0x000a,0x006d,0x00}, MOD_NONE, KEY_F3},
  // Blue
  {{0x07,0x000a,0x006e,0x00}, MOD_NONE, KEY_F4},
  
  // Shutdown menu
  {{0x07,0x000a,0x000c,0x00}, MOD_NONE, KEY_POWER},
